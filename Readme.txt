...
STEP 2
Download python.exe in order for the programme to work. Down below is the link to download the exe file
https://www.python.org/downloads/

Make sure to save the path in 'D:/Python Installation Folder/' because that is where the programme know where the python txt is located. 
